    ...
    <section id="pillars" ref={sectionRef} className="py-24">
      ...
      <div className="mt-16 flex flex-col">
        {pillars.map((pillar, i) => {
          ...
          const rowBgHex = isSoftRow ? "247,249,254" : "255,255,255";
            ...
            <div key={pillar.id} className={`${bg} py-10`}>
              <div className="mx-auto max-w-6xl px-6 md:px-12">
                <Card
                  ...
                  size="lg"
                  bordered
                  className="overflow-hidden rounded-[22px] border-stroke p-0 transition-shadow duration-300 hover:shadow-[0_18px_44px_rgba(99,128,211,0.16)]"
                >
                  <div
                    data-pillar-row
                  ...
                  >
                    ...
                    <div data-pillar-text className="flex flex-col justify-center px-8 py-8 md:px-10">
                      <div className="mb-3.5 flex items-center gap-3.5">
                        <div className="grid h-[46px] w-[46px] flex-none place-items-center rounded-full bg-brand text-lg font-bold text-white shadow-md shadow-brand/30">
                          {pillar.num[lang]}
                        </div>
                        <div className="h-px w-full max-w-16 flex-1 bg-stroke-strong" />
                      </div>
